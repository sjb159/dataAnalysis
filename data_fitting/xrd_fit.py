...
def fitData(x,y):
    ...
    model_3.set_param_hint("center", min = x[peaks[1]]-0.05, max = x[peaks[1]]+0.1)
    params_3 = model_3.make_params(amplitude = 1e-3, center = x[peaks[1]]+0.040, sigma = 0.04)
...
lScans =[186308,186324,186340,186359,186377,186442 ]
...
temparray = np.vstack([lTemp, lAreaLow,  lAreaLowErr, lArea , lAreaErr , lAreaHigh, lAreaHighErr])
